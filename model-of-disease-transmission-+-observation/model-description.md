...
All combinations of these situations can be quickly coded in COVID Scenario Pipeline. Details on how to encode these models is provided in the [Model Implementation](model-implementation/) section, with examples given in the [Tutorials section](../how-to/tutorials.md).
