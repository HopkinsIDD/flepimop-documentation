...
* Now load anaconda:\
  ...
  `module lode <latest anaconda environment>`
...
_This is only necessary if you intend to store model outputs on Amazon Web Services (AWS) s3 storage. If you are storing on your HPC or locally, skip this step._\
\
