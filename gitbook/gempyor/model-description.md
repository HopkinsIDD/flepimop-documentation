...
* The parameters and modifiers that applies to them.
...
All combinations of these situations can be quickly coded in COVID Scenario Pipeline. Details on how to encode these models is provided in the [Model Implementation](model-implementation/) section, with examples given in the [Tutorials](../how-to-run/tutorials.md) section.
...
Details on how to specify these outcomes in the model configuration files is provided in the [Model Implementation](model-implementation/) section, with examples given in the [Tutorials](../how-to-run/tutorials.md) section.
